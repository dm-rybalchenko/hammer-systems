...
export class EditProfile extends Component { 
	...
	render() {
		...
		const { name, email, userName, dateOfBirth, phoneNumber, website, address, city, postcode, avatarUrl } = this.props.history.location.state.selectedUser;
					...
					>
						<Row>
							<Col xs={24} sm={24} md={24} lg={16}>
								...
								<Button type="primary" htmlType="submit" onClick={() => {setTimeout(() => this.props.history.push('/app/main/clients/list'), 2000)} }>
									Save Change
								</Button>
							</Col>
						</Row>
